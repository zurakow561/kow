                ...
                <div class="modal-content animate">
                    ...
                    <form method="post">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $foto = $_POST['foto'];
                            $query = mysqli_query($koneksi, "INSERT INTO buku (KategoriID, Judul, Penulis, Penerbit, TahunTerbit, foto) VALUES ('$kategoriId', '$judul', '$penulis', '$penerbit', '$tahunTerbit', '$foto')");
